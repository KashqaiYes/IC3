...
import de.kashqai.industrialcraft3.block.entity.ElectricFurnaceBlockEntity;
...
public class ElectricFurnaceMenu extends AbstractContainerMenu {
    ...
    public ElectricFurnaceMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 34, 15));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 97, 34));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 34, 53));
        });
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 4;   // Height of arrow in pixels
